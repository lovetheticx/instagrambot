...
class Config:
    API_ID = int(os.environ.get("API_ID", "27886180"))
    API_HASH = os.environ.get("API_HASH", "10bbc3c3af349ac08d34bd34c139ea24")
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "6647217984:AAEoRF6Jc3r-x-DdMTHPX3I1lqyv9RELfTw") 
    USER = os.environ.get("INSTAGRAM_USERNAME", "love_for_jinx")
    OWNER = os.environ.get("OWNER_ID", "5464495002")
